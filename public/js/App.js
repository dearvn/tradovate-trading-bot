...
class App extends React.Component {
  ...
  render() {
    ...
    const stockWrappers = symbols.map((symbol, index) => {

      return (
        <StockWrapper
          extraClassName={
            index % 2 === 0 ? 'ticker-wrapper-even' : 'ticker-wrapper-odd'
          }
          key={'ticker-wrapper-' + symbol.symbol}
          connected={connected}
      ...
      <React.Fragment>
        ...
        {_.isEmpty(configuration) === false ? (
          <div className='app-body'>
            ...
            <div className='ticker-wrappers'>{stockWrappers}</div>

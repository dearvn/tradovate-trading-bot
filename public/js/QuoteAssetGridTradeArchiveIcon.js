...
class QuoteAssetGridTradeArchiveIcon extends React.Component {
  ...
  render() {
        ...
        <React.Fragment key={'quote-asset-grid-trade-row-' + row.key}>
          <tr>
            ...
            <td
              ...
              className={`text-center align-middle ${row.totalSellQuoteQty === 0 ? 'text-muted' : ''
                }`}>
    ...
    return (
      <div className='ticker-info-quote-asset-grid-trade-archive-wrapper d-inline-block'>
        <div className='ticker-info-column ticker-info-column-quote-asset-grid-trade-archive d-flex flex-row justify-content-start align-content-between border-bottom-0 mb-0 pb-0'>
          <button
            type='button'
        ...
        <Modal
          ...
          <Modal.Body>
            You are about to delete the existing closed logic trade.
            <br />
            <br />
            Do you want to delete the closed logic trade?
          </Modal.Body>
        ...
        <Modal
          ...
          <Modal.Body>
            You are about to delete the all closed logic trade.
            <br />
            <br />
            Do you want to delete the closed logic trade?
          </Modal.Body>

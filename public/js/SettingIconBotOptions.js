                                      ...
                                      overlay={
                                        <Popover id='bot-options-auto-trigger-buy-enabled-overlay-right'>
                                          <Popover.Content>
                                            ...
                                            logic trade for buying after removing
                                            the last buy price due to completed
                                            logic trades for selling. Note that
                                            this action may be triggered if you
                                            sell the ticker in Tradovate directly
                                        ...
                                        overlay={
                                          <Popover id='limit-share-right'>
                                            <Popover.Content>
                                              ...
                                              triggering the logic trade for
                                              buying. Once the time passes the
                                              configured minutes, the bot will
                                              trigger the logic trade for buying.
                                            </Popover.Content>
                                          </Popover>
                                        }>
                                        <Button

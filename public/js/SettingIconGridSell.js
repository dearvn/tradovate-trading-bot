...
class SettingIconGridSell extends React.Component {
  ...
  /**
   * Validate logic trade for puting
   *
   ...
   *  - Put amount cannot be less than the minimum notional value.
   */
  validateGridTrade(gridTrade) {
    ...
    this.props.handleSetValidation('gridPut', isValid);
  }
  ...
  render() {
    ...
    const gridRows = gridTrade.map((grid, i) => {
      ...
      return (
        <React.Fragment key={'grid-row-put-' + i}>
          <tr>
            <td className='align-middle font-weight-bold' width='90%'>
              <div className='row'>
                <div className='col-xs-12 col-sm-6'>
                  <Form.Group
                    controlId={'field-grid-put-' + i + '-enabled'}
                    className='mb-2'>
                    <Form.Check size='sm'>
                      <Form.Check.Input
                        type='checkbox'
                        data-state-key={`${i}.put.enabled`}
                        value={grid.triggerPercentage}
                        checked={grid.put && grid.put.enabled}
                      ...
                      <Form.Check.Label>
                        ...
                        <OverlayTrigger
                          trigger='click'
                          key='put-enabled-overlay'
                          placement='bottom'
                          overlay={
                            <Popover id={`${i}-put-enabled-overlay-right`}>
                              <Popover.Content>
                                If enabled, the bot will purchase the
                                ticker when it detects the put signal. If
          ...
          <tr>
            <td colSpan='2'>
              <div className='row'>
                ...
                <div className='col-xs-12 col-sm-6'>
                  <Form.Group
                    controlId={'field-grid-put-' + i + '-stop-loss'}
                    className='mb-2'>
                ...
                <div className='col-xs-12 col-sm-6'>
                  <Form.Group
                    controlId={'field-grid-put-' + i + '-stoploss_strong'}
                    className='mb-2'>
                    <Form.Label className='mb-0'>
                      Stoploss Strong{' '}
                      <OverlayTrigger
                        ...
                        overlay={
                          <Popover
                            id={
                              'field-grid-put-' +
                              i +
                              '-stoploss_strong-overlay-right'
                            }>
                            <Popover.Content>
                              Set the stoploss when market strong.
                            </Popover.Content>
                          </Popover>
                        }>
                        <Button
                    ...
                    <Form.Control
                      size='sm'
                      type='number'
                      placeholder='Enter stoploss strong'
                      required
                      min='0'
                      step='0.5'
                      isInvalid={
    ...
    return (
      <div className='ticker-info-grid-trade-wrapper ticker-info-grid-trade-put-wrapper' >
        ...
        <div className='row'>
          <div className='col-12 text-right'>
            <button
              type='button'
              className='btn btn-sm btn-add-new-grid-trade-put'

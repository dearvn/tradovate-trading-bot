...
class StockWrapperAction extends React.Component {
  render() {
    const {
      symbolInfo: {
        symbol,
      ...
      <div className='ticker-info-sub-wrapper'>
        <div className='ticker-info-column ticker-info-column-title border-bottom-0 mb-0 pb-0'>
          <div className='ticker-info-label'>
            Action -{' '}
            <HightlightChange className='ticker-info-value' id='updated-at'>
                ...
                overlay={
                  <Popover id='action-updated-at-alert-overlay-right'>
                    <Popover.Content>
                      ...
                      means the price hasn't changed in Tradovate. It will be
          ...
          <div className='d-flex flex-column align-items-end'>
            <HightlightChange
              className={`action-label ${label.length < 10 ? 'badge-pill badge-dark' : ''
                }`}>
              {label}
            </HightlightChange>
            {isActionDisabled.isDisabled === true ? (

...
class StockWrapperTradingView extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const quotePrecision =
      tickSize && parseFloat(tickSize) === 1 ? 0 : tickSize.indexOf(1) - 1;
    ...
    const oscillators = [
      ...
      return (
        <React.Fragment key={'tradingview-oscillator-' + i}>
          <div className='ticker-info-column ticker-info-column-tradingview fs-9'>
            <span className='ticker-info-label'>{oscillator.name}</span>
            <div className='ticker-info-value'>{oscillator.indicator}</div>
            <div
              className={
                'ticker-info-value ' +
    ...
    const movingAverages = [
      ...
      return (
        <React.Fragment key={'tradingview-moving-average-' + i}>
          <div className='ticker-info-column ticker-info-column-tradingview fs-9'>
            <span className='ticker-info-label'>{movingAverage.name}</span>
            <div className='ticker-info-value'>{movingAverage.indicator}</div>
            <div
              className={
                'ticker-info-value ' +
    ...
    if (connected && updatedAt.isBefore(currentTime)) {
      updatedWithinAlert = (
        <div className='ticker-info-column ticker-info-column-title border-bottom-0 m-0 p-0'>
      ...
      <div className='ticker-info-sub-wrapper'>
        ...
        <div className='d-flex flex-column w-100'>
          <div className='ticker-info-column ticker-info-column-price'>
            ...
            <HightlightChange
              className={
                'ticker-info-value font-weight-bold ' +
          ...
          <div className='ticker-info-column-rows ticker-info-column-price'>
            <div className='ticker-info-column-row'>
              <div className='ticker-info-column w-row-3 text-center text-danger'>
                Sell
              </div>
              <div className='ticker-info-column w-row-3 text-center text-muted'>
                Neutral
              </div>
              <div className='ticker-info-column w-row-3 text-center text-success'>
                Buy
              </div>
            </div>
            <div className='ticker-info-column-row'>
          ...
          <div className='ticker-info-column ticker-info-column-price'>
            <span
              className='ticker-info-value font-italic fs-9'
